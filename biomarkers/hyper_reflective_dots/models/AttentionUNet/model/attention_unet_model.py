...
class AttentionUNet(nn.Module):
    ...
    def __init__(self, in_channels=1, out_classes=1):
        ...
        # Encoder - modify first conv for grayscale input
        ...
        self.enc1 = nn.Sequential(self.enc1_conv, self.enc1_bn, self.enc1_relu)
...
def get_attention_unet_model(in_channels=1, out_classes=1):
    """
    Returns an Attention U-Net model for heatmap prediction.
    Output is raw logits (sigmoid applied during inference).
    """
